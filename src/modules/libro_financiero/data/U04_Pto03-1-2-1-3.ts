...
Si $1+g>1$
<blockquote><i>Cuotas Crecientes. En este caso la tasa de crecimiento $g$ es positiva.</i></blockquote>
Si $1+g=1$
<blockquote><i>Cuotas Constantes y se obtiene la fórmula particular de las rentas temporarias inmediatas con cuotas constantes. En este caso la tasa de crecimiento/decrecimiento $g$ es nula.</i></blockquote>
Si $0<1+g<1$
<blockquote><i>Cuotas Decrecientes. En este caso la tasa de decrecimiento $g$ es negativa (es estrictamente mayor al 0% y estrictamente menor al 100%, en valores absolutos).</i></blockquote>
Si $1+g=0$
<blockquote><i>Solo existiría la primera cuota, dado que las siguientes se anulan, por lo que no se está en presencia de una renta. En este caso, el valor de $g$ sería del 100% negativo (-1), pero no es un valor factible que la tasa de crecimiento/decrecimiento $g$ pueda asumir válidamente.</i></blockquote>
Si $1+g<0$
<blockquote><i>Cuotas de Signos Alternados, lo cual no es factible porque contradice el concepto de rentas. En este caso, el valor de $g$ sería negativo y superior al 100%, pero no es un valor factible que la tasa de crecimiento/decrecimiento $g$ pueda asumir válidamente.</i></blockquote>
