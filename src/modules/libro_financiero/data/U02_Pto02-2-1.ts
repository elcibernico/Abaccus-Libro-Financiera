...
const data: TopicData = {
  ...
  {
    "type": "text",
    "content": "**Definición y Características**\nEl **Descuento Racional Compuesto** ($D_3$) se define como el interés compuesto calculado sobre la suma efectivamente recibida (Valor Actual) trabajando con una tasa periódica efectiva de interés $i$.\n\nA diferencia del régimen simple, en este sistema la actualización implica que la detracción de intereses se realiza sobre el valor capital disponible en cada subperíodo, lo que conlleva una disminución de la base de cálculo a medida que nos alejamos del vencimiento.\n\nPor lo tanto, toda vez que se quiera calcular el costo efectivo en una operación de descuento, deberá plantearse una equivalencia entre un hecho real y un hecho supuesto, a fin de determinar la tasa efectiva de interés $i$ implícita en la operación. El hecho real, será que un nominal $N$ se descuenta por $n$ períodos en el régimen que se pacte, en tanto que, el hecho supuesto, siempre será que ese mismo nominal $N$ se descuenta por los mismos $n$ períodos, pero ahora en régimen racional compuesto con actualización periódica, a la tasa periódica efectiva de interés $i$, que será la incógnita a dilucidar."
  },
  {
    "type": "text",
