...
A diferencia del régimen simple —donde el descuento puede ser constante si se calcula sobre el nominal (o el valor efectivo)—, en el régimen compuesto el descuento es **variable y decreciente** período a período. Esto sucede porque:
