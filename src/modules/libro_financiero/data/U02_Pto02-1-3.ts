...
Realizando el despeje correspondiente de la igualdad anterior: $$f \\cdot n = 1 - \\frac{1}{1 + j \\cdot n}$$ Para poder restar la fracción del número entero 1, necesitamos que ambos términos compartan la misma base.Usamos el siguiente artilugio matemático: expresamos el número 1 como una fracción donde el numerador y el denominador sean exactamente iguales al denominador de la segunda fracción, que es $(1 + j \\cdot n)$ $$1 = \\frac{1 + j \\cdot n}{1 + j \\cdot n}$$ Sustituimos esta equivalencia en la ecuación original:$$f \\cdot n = \\frac{1 + j \\cdot n}{1 + j \\cdot n} - \\frac{1}{1 + j \\cdot n}$$ Aplicando la propiedad distributiva de la división respecto de la resta, como los denominadores son iguales, podemos unificar los numeradores sobre una única línea de fracción:$$f \\cdot n = \\frac{1 + j \\cdot n - 1}{1 + j \\cdot n}$$
$$f \\cdot n = \\frac{j \\cdot n}{1 + j \\cdot n}$$ $$f = \\frac{j \\cdot n}{n \\cdot (1 + j \\cdot n)}$$ $$f = \\frac{j}{1 + j \\cdot n}$$`
  },
  {
    "type": "text",
    "content": `**B. Obtención de $j$ en función de $f$**
Partiendo nuevamente de la igualdad de valores efectivos: $$1 + j \\cdot n = \\frac{1}{1 - f \\cdot n}$$ $$j \\cdot n = \\frac{1}{1 - f \\cdot n} - 1$$ 
 Como el denominador de la fracción del primer término del miembro de la derecha es $(1 - f \\cdot n)$, transformamos el 1 en:$$1 = \\frac{1 - f \\cdot n}{1 - f \\cdot n}$$
Ahora sustituimos esto en nuestra ecuación:$$j \\cdot n = \\frac{1}{1 - f \\cdot n} - \\frac{1 - f \\cdot n}{1 - f \\cdot n}$$
Sacamos factor común: $$j \\cdot n = \\frac{1 - (1 - f \\cdot n)}{1 - f \\cdot n}$$ $$j \\cdot n = \\frac{1 - 1 + f \\cdot n}{1 - f \\cdot n}$$ $$j \\cdot n = \\frac{f \\cdot n}{1 - f \\cdot n}$$
Para dejar a la variable $j$ completamente sola, necesitamos quitar la $n$ que la está multiplicando. Aplicamos nuevamente la propiedad uniforme, dividiendo ambos lados de la ecuación por $n$ (o lo que es lo mismo, multiplicando por el inverso $\\frac{1}{n}$): $$j \\cdot n \\cdot \\frac{1}{n} = \\frac{(\\frac{f \\cdot n}{1 - f \\cdot n})}{n}$$ 
 $$j \\cdot n \\cdot \\frac{1}{n} = \\frac{(\\frac{f \\cdot n}{1 - f \\cdot n})}{\\frac{n}{1}}$$ 
 $$j = \\frac{f \\cdot n}{n \\cdot (1 - f \\cdot n)}$$ 
 $$j = \\frac{f}{1 - f \\cdot n}$$`
  },
  {
    "type": "text",
