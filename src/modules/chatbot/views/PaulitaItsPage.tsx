      ...
      <header className="chat-header glass-header">
        ...
        <div className="header-info">
          ...
          <div>
            ...
            <p className="bot-subtitle">Tutor Inteligente • Matemática Financiera • v1.0.0</p>
          </div>
        </div>
        ...
        <div className="history-scroll-inner">
          <AnimatePresence initial={false}>
            {messages.map((msg) => (
              ...
              >
                <div className="message-avatar" style={{ display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'center' }}>
